package com.atguigu.designPattern03.day07adapter.demo.objectadapter;
 ...
 *
 *      对象适配器模式应用实例：
 *          应用实例说明以生活中充电器的例子来讲解适配器，充电器本身相当于Adapter，220V交流电相当于src (即被适配者)，
 *          我们的目dst(即目标)是5V直流电，使用对象适配器模式完成。
 *
 *      对象适配器模式注意事项和细节：
