package com.atguigu.designPattern03.day09composite;
 ...
 *          2）Leaf：在组合中表示叶子节点，叶子节点没有子节点。（它是被管理者）
 *          3）Composite：非叶子节点，用于存储子部件，在 Component接口中实现 子部件的相关操作，比如增加(add), 删除等。
 *
 *      组合模式解决的问题：
 *          组合模式解决这样的问题，当我们的要处理的对象可以生成一颗树形结构，而我们要对树上的节点和叶子进行操作时，
